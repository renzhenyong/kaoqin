...
Page({
  ...
  tijiao(){
    ...
    app.post('askLeave', { sid: this.data.sid, leave_type: 1, start_date: this.data.startDate, end_date: this.data.endDate, day_length: this.data.inputValue, remark: this.data.reason},  res => {
    //     console.log(res);
        if (res.data.code == 1) {
          wx.navigateTo({
